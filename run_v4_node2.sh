#!/bin/bash
# Node 2: grpo_hard_v4 (train + process eval)
# NOTE: grpo_edge_v4 already completed successfully
set -e
...
run_and_eval "grpo_hard_v4" "grpo_hard_v4"

TOTAL_END=$(date +%s)
TOTAL_DURATION=$(( TOTAL_END - TOTAL_START ))
HOURS=$(( TOTAL_DURATION / 3600 ))
MINS=$(( (TOTAL_DURATION % 3600) / 60 ))
echo "Node 2 Complete! Total wall time: ${HOURS}h ${MINS}m"
