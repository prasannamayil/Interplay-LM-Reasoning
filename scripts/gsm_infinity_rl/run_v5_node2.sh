#!/bin/bash
# =============================================================================
# V5 DPG experiments -- node 2 of 2
# Runs: DR-GRPO DPG(eta=2), DR-GSPO baseline + DPG
#
# 4 runs total: train sequentially, eval final checkpoint of each with
...
RUNS=(
    "dr_grpo_dpg_eta2_edge_v5"
    "dr_gspo_edge_v5"
    "dr_gspo_dpg_eta05_edge_v5"
    "dr_gspo_dpg_eta2_edge_v5"
)
...
echo "================================================================================"
echo "V5 DPG experiments -- node 2 (${TOTAL} runs)"
echo "================================================================================"
echo "Runs: ${RUNS[*]}"
