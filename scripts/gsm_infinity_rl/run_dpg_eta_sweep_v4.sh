#!/bin/bash
# =============================================================================
# Train 3 DPG eta variants (eta=0.5, 1.0, 2.0) and evaluate final checkpoint
...
#
# Usage:
#   bash scripts/gsm_infinity_rl/run_dpg_eta_sweep_v4.sh
#   bash scripts/gsm_infinity_rl/run_dpg_eta_sweep_v4.sh --eval-only
#   bash scripts/gsm_infinity_rl/run_dpg_eta_sweep_v4.sh --skip-train
# =============================================================================
...
echo "================================================================================"
echo "DPG eta sweep: train + process-verified final-checkpoint eval"
echo "================================================================================"
echo "Runs: ${RUNS[*]}"
...
for ((i=0; i<TOTAL; i++)); do
    ...
    # Merge FSDP shards -> HuggingFace format if needed
    ...
    # Run pass@128 evaluation with process-verified reward
    mkdir -p "$EVAL_DIR"
