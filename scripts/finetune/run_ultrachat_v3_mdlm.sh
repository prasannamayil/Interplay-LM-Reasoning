#!/bin/bash
# =============================================================================
# NODE 3: Finetune MDLM on UltraChat 200k (v3), then evaluate.
# =============================================================================
...
#
# Usage: bash scripts/finetune/run_ultrachat_v3_mdlm.sh [2.8b]
# =============================================================================
...
echo "=== Eval MDLM (DUEL --log_samples + val NLL) ==="
...
echo "  Training:  results/finetune/pythia-${SIZE}-mdlm-${DATASET_TAG}/"
echo "  Eval:      results/finetune_eval_samples/mdlm/..."
echo "============================================================"
