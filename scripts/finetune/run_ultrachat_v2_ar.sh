#!/bin/bash
# =============================================================================
# NODE 1: Finetune Pythia + Mamba on UltraChat 200k (v2), then evaluate.
# =============================================================================
...
# Preprocessed data with train/val split (val held out from training).
# All evals run with --log_samples for loss-vs-loss analysis.
#
# Usage: bash scripts/finetune/run_ultrachat_v2_ar.sh [2.8b]
# =============================================================================
...
SAVE_TOTAL_LIMIT=42             # keep all 40 + final + buffer
...
# ── Step 1: Preprocess (shared with diffusion, with val split) ────────
...
echo "============================================================"
echo "NODE 1: AR models (Pythia + Mamba) | v2 | Size: ${SIZE}"
echo "  Data: ${PREPROCESSED_DIR}"
echo "  Epochs: ${NUM_TRAIN_EPOCHS} | Save every ${SAVE_STEPS} steps (~40 ckpts)"
echo "  Eval: ${NUM_CKPTS} ckpts + base + final | Val NLL: ${VAL_NUM_EXAMPLES} examples"
echo "  Tasks: ${TASKS}"
echo "============================================================"
echo ""
...
# Uses reeval-style direct launch for --log_samples support.
