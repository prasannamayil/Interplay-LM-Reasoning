#!/bin/bash
# =============================================================================
# NODE 2: Finetune BD3LM (bs=1, bs=16) on UltraChat 200k (v2), then evaluate.
# =============================================================================
...
#
# Usage: bash scripts/finetune/run_ultrachat_v2_bd3lm.sh [2.8b]
# =============================================================================
...
# ── Step 1: Preprocess (shared, with val split) ──────────────────────
...
echo "============================================================"
echo "NODE 2: BD3LM (bs=1, bs=16) | v2 | Size: ${SIZE}"
...
echo "  Training:  results/finetune/pythia-${SIZE}-bd3lm-bs{1,16}-${DATASET_TAG}/"
