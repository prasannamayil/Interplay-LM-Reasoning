#!/bin/bash
# =============================================================================
# Eval-only: BD3LM bs=8 on UltraChat 200k v3 (DUEL lm_eval + val NLL).
# Assumes training already done: results/finetune/pythia-2.8b-bd3lm-bs8-ultrachat200k-v3/
# =============================================================================
# Usage: bash scripts/finetune/eval_ultrachat_v3_bd3lm_bs8.sh [2.8b]
# =============================================================================
...
RUN_DIR="${PROJECT_ROOT}/results/finetune/pythia-${SIZE}-bd3lm-bs8-${DATASET_TAG}"
...
echo "============================================================"
echo "Eval BD3LM bs=8 v3 | Size: ${SIZE} | Run: ${run_name}"
...
echo ""
echo "============================================================"
echo "Eval bs=8 complete. Results: ${OUTPUT_ROOT}/bd3lm/${run_name}/"
echo "============================================================"
