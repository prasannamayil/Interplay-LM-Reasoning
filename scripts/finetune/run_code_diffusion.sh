#!/bin/bash
# =============================================================================
# Finetune BD3LM + MDLM (diffusion) on OPC-SFT (code), then evaluate.
# =============================================================================
# Trains diffusion models on code instruction data, evaluates on:
...
#   BD3LM_BLOCK_SIZES="1 8 16 32 64" bash scripts/finetune/run_code_diffusion.sh 2.8b
#
# Usage: bash scripts/finetune/run_code_diffusion.sh [2.8b]
# =============================================================================
...
echo "============================================================"
echo "CODE DIFFUSION: BD3LM (bs=${BD3LM_BLOCK_SIZES}) + MDLM | Size: ${SIZE}"
...
echo ""
echo "============================================================"
echo "CODE DIFFUSION COMPLETE. Results:"
