#!/bin/bash
# Node 3: grpo_uniform_v4 (train + process eval)
# Also handles data prep for uniform distribution
set -e
...
echo "================================================================"
echo "[Node 3] Data Prep for Uniform Distribution (op 2-20)"
echo "================================================================"
if [ -f "data/rl_finetune/train/uniform/uniform_200k.jsonl" ]; then
    echo "Uniform data already exists, skipping."
else
...
run_and_eval "grpo_uniform_v4" "grpo_uniform_v4"

TOTAL_END=$(date +%s)
TOTAL_DURATION=$(( TOTAL_END - TOTAL_START ))
HOURS=$(( TOTAL_DURATION / 3600 ))
MINS=$(( (TOTAL_DURATION % 3600) / 60 ))
echo "Node 3 Complete! Total wall time: ${HOURS}h ${MINS}m"
